...
type biome_search_options = {bounding_size: option<vector3>}
...
type play_animation_options = {blend_out_time: option<float>, controller: option<string>, next_state: option<string>, players: option<array<string>>, stop_expression: option<string>}
type projectile_shoot_options = {uncertainty: option<float>}
type rgba = {blue: float, green: float, red: float, alpha: float}

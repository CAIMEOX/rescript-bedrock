...
/* Module @minecraft/server v1.9.0-beta for Minecraft 1.20.60-beta.26 */
/* Enum definition */
type block_component_types =
  | @as("minecraft:inventory") Inventory
  | @as("minecraft:lavaContainer") LavaContainer
  | @as("minecraft:piston") Piston
  | @as("minecraft:potionContainer") PotionContainer
  | @as("minecraft:recordPlayer") RecordPlayer
  | @as("minecraft:sign") Sign
  | @as("minecraft:snowContainer") SnowContainer
  | @as("minecraft:waterContainer") WaterContainer
type block_piston_state =
  | @as("Expanded") Expanded
  | @as("Expanding") Expanding
  | @as("Retracted") Retracted
  | @as("Retracting") Retracting
...
type easing_type =
  | @as("InBack") InBack
  | @as("InBounce") InBounce
  | @as("InCirc") InCirc
  | @as("InCubic") InCubic
  | @as("InElastic") InElastic
  | @as("InExpo") InExpo
  | @as("InOutBack") InOutBack
  | @as("InOutBounce") InOutBounce
  | @as("InOutCirc") InOutCirc
  | @as("InOutCubic") InOutCubic
  | @as("InOutElastic") InOutElastic
  | @as("InOutExpo") InOutExpo
  | @as("InOutQuad") InOutQuad
  | @as("InOutQuart") InOutQuart
  | @as("InOutQuint") InOutQuint
  | @as("InOutSine") InOutSine
  | @as("InQuad") InQuad
  | @as("InQuart") InQuart
  | @as("InQuint") InQuint
  | @as("InSine") InSine
  | @as("Linear") Linear
  | @as("OutBack") OutBack
  | @as("OutBounce") OutBounce
  | @as("OutCirc") OutCirc
  | @as("OutCubic") OutCubic
  | @as("OutElastic") OutElastic
  | @as("OutExpo") OutExpo
  | @as("OutQuad") OutQuad
  | @as("OutQuart") OutQuart
  | @as("OutQuint") OutQuint
  | @as("OutSine") OutSine
  | @as("Spring") Spring
type entity_component_types =
  | @as("minecraft:addrider") AddRider
  | @as("minecraft:ageable") Ageable
  | @as("minecraft:breathable") Breathable
  | @as("minecraft:can_climb") CanClimb
  | @as("minecraft:can_fly") CanFly
  | @as("minecraft:can_power_jump") CanPowerJump
  | @as("minecraft:color") Color
  | @as("minecraft:equippable") Equippable
  | @as("minecraft:fire_immune") FireImmune
  | @as("minecraft:floats_in_liquid") FloatsInLiquid
  | @as("minecraft:flying_speed") FlyingSpeed
  | @as("minecraft:friction_modifier") FrictionModifier
  | @as("minecraft:ground_offset") GroundOffset
  | @as("minecraft:healable") Healable
  | @as("minecraft:health") Health
  | @as("minecraft:inventory") Inventory
  | @as("minecraft:is_baby") IsBaby
  | @as("minecraft:is_charged") IsCharged
  | @as("minecraft:is_chested") IsChested
  | @as("minecraft:is_dyeable") IsDyeable
  | @as("minecraft:is_hidden_when_invisible") IsHiddenWhenInvisible
  | @as("minecraft:is_ignited") IsIgnited
  | @as("minecraft:is_illager_captain") IsIllagerCaptain
  | @as("minecraft:is_saddled") IsSaddled
  | @as("minecraft:is_shaking") IsShaking
  | @as("minecraft:is_sheared") IsSheared
  | @as("minecraft:is_stackable") IsStackable
  | @as("minecraft:is_stunned") IsStunned
  | @as("minecraft:is_tamed") IsTamed
  | @as("minecraft:item") Item
  | @as("minecraft:lava_movement") LavaMovement
  | @as("minecraft:leashable") Leashable
  | @as("minecraft:mark_variant") MarkVariant
  | @as("minecraft:tamemount") MountTaming
  | @as("minecraft:movement") Movement
  | @as("minecraft:movement.amphibious") MovementAmphibious
  | @as("minecraft:movement.basic") MovementBasic
  | @as("minecraft:movement.fly") MovementFly
  | @as("minecraft:movement.generic") MovementGeneric
  | @as("minecraft:movement.glide") MovementGlide
  | @as("minecraft:movement.hover") MovementHover
  | @as("minecraft:movement.jump") MovementJump
  | @as("minecraft:movement.skip") MovementSkip
  | @as("minecraft:movement.sway") MovementSway
  | @as("minecraft:navigation.climb") NavigationClimb
  | @as("minecraft:navigation.float") NavigationFloat
  | @as("minecraft:navigation.fly") NavigationFly
  | @as("minecraft:navigation.generic") NavigationGeneric
  | @as("minecraft:navigation.hover") NavigationHover
  | @as("minecraft:navigation.walk") NavigationWalk
  | @as("minecraft:npc") Npc
  | @as("minecraft:onfire") OnFire
  | @as("minecraft:projectile") Projectile
  | @as("minecraft:push_through") PushThrough
  | @as("minecraft:rideable") Rideable
  | @as("minecraft:riding") Riding
  | @as("minecraft:scale") Scale
  | @as("minecraft:skin_id") SkinId
  | @as("minecraft:strength") Strength
  | @as("minecraft:tameable") Tameable
  | @as("minecraft:underwater_movement") UnderwaterMovement
  | @as("minecraft:variant") Variant
  | @as("minecraft:wants_jockey") WantsJockey
type entity_damage_cause =
  | @as("anvil") Anvil
  | @as("blockExplosion") BlockExplosion
  | @as("campfire") Campfire
  | @as("charging") Charging
  | @as("contact") Contact
  | @as("drowning") Drowning
  | @as("entityAttack") EntityAttack
  | @as("entityExplosion") EntityExplosion
  | @as("fall") Fall
  | @as("fallingBlock") FallingBlock
  | @as("fire") Fire
  | @as("fireTick") FireTick
  | @as("fireworks") Fireworks
  | @as("flyIntoWall") FlyIntoWall
  | @as("freezing") Freezing
  | @as("lava") Lava
  | @as("lightning") Lightning
  | @as("magic") Magic
  | @as("magma") Magma
  | @as("none") None
  | @as("override") Override
  | @as("piston") Piston
  | @as("projectile") Projectile
  | @as("ramAttack") RamAttack
  | @as("sonicBoom") SonicBoom
  | @as("soulCampfire") SoulCampfire
  | @as("stalactite") Stalactite
  | @as("stalagmite") Stalagmite
  | @as("starve") Starve
  | @as("suffocation") Suffocation
  | @as("suicide") Suicide
  | @as("temperature") Temperature
  | @as("thorns") Thorns
  | @as("void") Void
  | @as("wither") Wither
type entity_initialization_cause =
  | @as("Born") Born
  | @as("Event") Event
  | @as("Loaded") Loaded
  | @as("Spawned") Spawned
  | @as("Transformed") Transformed
...
type equipment_slot =
  ...
  | @as("Head") Head
  | @as("Legs") Legs
  | @as("Mainhand") Mainhand
  | @as("Offhand") Offhand
type fluid_type =
  | @as("Lava") Lava | @as("Potion") Potion | @as("PowderSnow") PowderSnow | @as("Water") Water
type game_mode =
  | @as("adventure") Adventure
  | @as("creative") Creative
  | @as("spectator") Spectator
  | @as("survival") Survival
type item_component_types =
  | @as("minecraft:cooldown") Cooldown
  | @as("minecraft:durability") Durability
  | @as("minecraft:enchantable") Enchantable
  | @as("minecraft:food") Food
...
type scoreboard_identity_type =
  | @as("Entity") Entity | @as("FakePlayer") FakePlayer | @as("Player") Player
type script_event_source =
  | @as("Block") Block
  | @as("Entity") Entity
  | @as("NPCDialogue") NPCDialogue
  | @as("Server") Server
...
exception EnchantmentLevelOutOfBoundsError
exception EnchantmentTypeNotCompatibleError
exception EnchantmentTypeUnknownIdError
exception InvalidContainerSlotError
...
type _EntityProjectileComponent
...
type _ItemEnchantableComponent
...
type _WeatherChangeBeforeEvent
type _WeatherChangeBeforeEventSignal
type _World
...
type scoreboard_objective_display_options = {
  objective: _ScoreboardObjective,
  sort_order?: objective_sort_order,
}
type raw_message_score = {name?: string, objective?: string}
type rec raw_message = {
  rawtext?: array<raw_message>,
  score?: raw_message_score,
  text?: string,
  translate?: string,
  @as("with") with_?: @unwrap [#Array(array<string>) | #RawMessage(raw_message)],
}
type raw_text = {rawtext?: array<raw_message>}
type entity_query_score_options = {
  exclude?: bool,
  max_score?: int32,
  min_score?: int32,
  objective?: string,
...
type definition_modifier = {
  added_component_groups: array<string>,
  removed_component_groups: array<string>,
  triggers: array<_Trigger>,
}
type vector2 = {x: float, y: float}
type explosion_options = {
...
type entity_hit_information = {entity?: _Entity}
type entity_event_options = {entities?: array<_Entity>, entity_types?: array<string>}
type entity_data_driven_trigger_event_options = {
  entities?: array<_Entity>,
  entity_types?: array<string>,
  event_types?: array<string>,
}
type entity_damage_source = {
  cause: entity_damage_cause,
  damaging_entity?: _Entity,
  damaging_projectile?: _Entity,
}
type entity_apply_damage_options = {cause: entity_damage_cause, damaging_entity?: _Entity}
type entity_apply_damage_by_projectile_options = {
  damaging_entity?: _Entity,
  damaging_projectile: _Entity,
}
...
type camera_fade_options = {fade_color?: rgb, fade_time?: camera_fade_time_options}
type camera_ease_options = {ease_time?: float, ease_type?: easing_type}
type camera_default_options = {ease_options: camera_ease_options}
type block_fill_options = {matching_block?: _BlockPermutation}
type block_event_options = {block_types?: array<string>, permutations?: array<_BlockPermutation>}
type vector3 = {x: float, y: float, z: float}
type teleport_options = {
  check_for_blocks?: bool,
  dimension?: _Dimension,
  facing_location?: vector3,
  keep_velocity?: bool,
  rotation?: vector2,
}
type player_sound_options = {location?: vector3, pitch?: float, volume?: float}
type entity_query_options = {
  closest?: int32,
  exclude_families?: array<string>,
  exclude_game_modes?: array<game_mode>,
  ...
  location?: vector3,
  max_distance?: float,
  max_horizontal_rotation?: float,
  max_level?: int32,
  max_vertical_rotation?: float,
  min_distance?: float,
  min_horizontal_rotation?: float,
  min_level?: int32,
  min_vertical_rotation?: float,
  name?: string,
  score_options?: array<entity_query_score_options>,
  tags?: array<string>,
  @as("type") type_?: string,
  volume?: _BlockAreaSize,
}
type camera_set_rot_options = {
  ease_options?: camera_ease_options,
  location?: vector3,
  rotation: vector2,
}
type camera_set_pos_options = {
  ease_options?: camera_ease_options,
  facing_location: vector3,
  location?: vector3,
}
type camera_set_location_options = {ease_options?: camera_ease_options, location: vector3}
type camera_set_facing_options = {
  ease_options?: camera_ease_options,
  facing_entity: _Entity,
  location?: vector3,
}
type bounding_box = {max: vector3, min: vector3}
type block_volume = {from: vector3, to: vector3}
type compound_block_volume_item = {
  action?: compound_block_volume_action,
  location_relativity?: compound_block_volume_position_relativity,
  volume: block_volume,
}
...
type biome_search_options = {bounding_size?: vector3}
type block_raycast_options = {
  include_liquid_blocks?: bool,
  include_passable_blocks?: bool,
  max_distance?: int32,
}
type enchantment = {
  level: int32,
  @as("type") type_: @unwrap [#EnchantmentType(_EnchantmentType) | #String(string)],
}
type entity_effect_options = {amplifier?: int32, show_particles?: bool}
type entity_raycast_options = {max_distance?: int32}
type music_options = {fade?: float, loop?: bool, volume?: float}
type play_animation_options = {
...
type projectile_shoot_options = {uncertainty?: float}
type rgba = {alpha: float, ...rgb}
type script_event_message_filter_options = {namespaces: array<string>}
type title_display_options = {
  fade_in_duration: int32,
  fade_out_duration: int32,
  stay_duration: int32,
  subtitle?: @unwrap
  [
    | #Array(array<@unwrap [#RawMessage(raw_message) | #String(string)]>)
    | #RawMessage(raw_message)
    | #String(string)
  ],
}
type world_sound_options = {pitch?: float, volume?: float}
type number_range = {min: int, max: int}
/* Class definition */
module IPlayerSpawnAfterEventSignal = {
  ...
  module Impl = (
    ...
    @send
    external subscribe: (T.t, _PlayerSpawnAfterEvent => unit) => _PlayerSpawnAfterEvent => unit =
      "subscribe"
...
module IPlayerLeaveAfterEventSignal = {
  ...
  module Impl = (
    ...
    @send
    external subscribe: (T.t, _PlayerLeaveAfterEvent => unit) => _PlayerLeaveAfterEvent => unit =
      "subscribe"
...
module IPlayerJoinAfterEventSignal = {
  ...
  module Impl = (
    ...
    @send
    external subscribe: (T.t, _PlayerJoinAfterEvent => unit) => _PlayerJoinAfterEvent => unit =
      "subscribe"
...
module Entity = {
  ...
  module Impl = (
    ...
    external addEffect: (
      T.t,
      @unwrap [#EffectType(_EffectType) | #String(string)],
      int32,
      ~options: entity_effect_options=?,
    ) => option<_Effect> = "addEffect"
    @send external addTag: (T.t, string) => bool = "addTag"
    @send
    external applyDamage: (
      T.t,
      float,
      ~options: @unwrap
      [
        | #EntityApplyDamageByProjectileOptions(entity_apply_damage_by_projectile_options)
        | #EntityApplyDamageOptions(entity_apply_damage_options)
      ]=?,
    ) => bool = "applyDamage"
    ...
    @send external extinguishFire: (T.t, bool) => bool = "extinguishFire"
    @send @return(nullable)
    external getBlockFromViewDirection: (
      T.t,
      ~options: block_raycast_options=?,
    ) => option<block_raycast_hit> = "getBlockFromViewDirection"
    @send @return(nullable)
    external getComponent: (T.t, string) => option<_EntityComponent> = "getComponent"
    @send external getComponents: T.t => array<_EntityComponent> = "getComponents"
    @send @return(nullable)
    external getDynamicProperty: (
      T.t,
      string,
    ) => option<
      @unwrap
      [#Boolean(bool) | #Double(float) | #Float(float) | #String(string) | #Vector3(vector3)],
    > = "getDynamicProperty"
    @send external getDynamicPropertyIds: T.t => array<string> = "getDynamicPropertyIds"
    @send
    external getDynamicPropertyTotalByteCount: T.t => int32 = "getDynamicPropertyTotalByteCount"
    @send @return(nullable)
    external getEffect: (
      T.t,
      @unwrap [#EffectType(_EffectType) | #String(string)],
    ) => option<_Effect> = "getEffect"
    @send external getEffects: T.t => array<_Effect> = "getEffects"
    @send
    external getEntitiesFromViewDirection: (
      T.t,
      ~options: entity_raycast_options=?,
    ) => array<entity_raycast_hit> = "getEntitiesFromViewDirection"
    @send external getHeadLocation: T.t => vector3 = "getHeadLocation"
    @send @return(nullable)
    external getProperty: (
      T.t,
      string,
    ) => option<@unwrap [#Boolean(bool) | #Float(float) | #String(string)]> = "getProperty"
    ...
    @send
    external playAnimation: (T.t, string, ~options: play_animation_options=?) => unit =
      "playAnimation"
    @send external remove: T.t => unit = "remove"
    @send
    external removeEffect: (T.t, @unwrap [#EffectType(_EffectType) | #String(string)]) => bool =
      "removeEffect"
    @send external removeTag: (T.t, string) => bool = "removeTag"
    @send
    external resetProperty: (
      T.t,
      string,
    ) => @unwrap [#Boolean(bool) | #Float(float) | #String(string)] = "resetProperty"
    ...
    @send
    external setDynamicProperty: (
      T.t,
      string,
      ~value: @unwrap
      [#Boolean(bool) | #Double(float) | #Float(float) | #String(string) | #Vector3(vector3)]=?,
    ) => unit = "setDynamicProperty"
    @send external setOnFire: (T.t, int32, bool) => bool = "setOnFire"
    @send
    external setProperty: (
      T.t,
      string,
      @unwrap [#Boolean(bool) | #Float(float) | #String(string)],
    ) => unit = "setProperty"
    @send external setRotation: (T.t, vector2) => unit = "setRotation"
    @send
    external teleport: (T.t, vector3, ~teleportOptions: teleport_options=?) => unit = "teleport"
    @send external triggerEvent: (T.t, string) => unit = "triggerEvent"
    @send
    external tryTeleport: (T.t, vector3, ~teleportOptions: teleport_options=?) => bool =
      "tryTeleport"
...
module ILeverActionAfterEventSignal = {
  ...
  module Impl = (
    ...
    @send
    external subscribe: (T.t, _LeverActionAfterEvent => unit) => _LeverActionAfterEvent => unit =
      "subscribe"
...
module IButtonPushAfterEventSignal = {
  ...
  module Impl = (
    ...
    @send
    external subscribe: (T.t, _ButtonPushAfterEvent => unit) => _ButtonPushAfterEvent => unit =
      "subscribe"
...
module BiomeTypes = {
  type t = _BiomeTypes
  @send @return(nullable) external get: (t, string) => option<_BiomeType> = "get"
  @send external getAll: t => array<_BiomeType> = "getAll"
}
...
module Block = {
  ...
  external canPlace: (
    t,
    @unwrap [#BlockPermutation(_BlockPermutation) | #BlockType(_BlockType) | #String(string)],
    ~faceToPlaceOn: direction=?,
  ) => bool = "canPlace"
  @send external center: t => vector3 = "center"
  @send @return(nullable) external east: (t, int32) => option<t> = "east"
  @send @return(nullable)
  external getComponent: (t, string) => option<_BlockComponent> = "getComponent"
  @send @return(nullable)
  external getItemStack: (t, int32, bool) => option<_ItemStack> = "getItemStack"
  ...
  external matches: (
    t,
    string,
    ~states: Belt.Map.String.t<@unwrap [#Boolean(bool) | #Int32(int32) | #String(string)]>=?,
  ) => bool = "matches"
  ...
  @send
  external setType: (t, @unwrap [#BlockType(_BlockType) | #String(string)]) => unit = "setType"
  @send external setWaterlogged: (t, bool) => unit = "setWaterlogged"
...
module BlockExplodeAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _BlockExplodeAfterEvent => unit) => _BlockExplodeAfterEvent => unit =
    "subscribe"
...
module BlockInventoryComponent = {
  ...
  @module("@minecraft/server") @scope("BlockInventoryComponent") @val
  external componentId: string = "componentId"
...
module BlockLavaContainerComponent = {
  ...
  include BlockLiquidContainerComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("BlockLavaContainerComponent") @val
  external componentId: string = "componentId"
}
...
module BlockPermutation = {
  ...
  @send
  external getAllStates: t => Belt.Map.String.t<
    @unwrap [#Boolean(bool) | #Int32(int32) | #String(string)],
  > = "getAllStates"
  ...
  external getState: (
    t,
    string,
  ) => option<@unwrap [#Boolean(bool) | #Int32(int32) | #String(string)]> = "getState"
  @send external getTags: t => array<string> = "getTags"
  @send external hasTag: (t, string) => bool = "hasTag"
  @send
  external matches: (
  ...
  @send
  external withState: (t, string, @unwrap [#Boolean(bool) | #Int32(int32) | #String(string)]) => t =
    "withState"
  @get external getType: t => _BlockType = "type"
}
...
module BlockPistonComponent = {
  ...
  @module("@minecraft/server") @scope("BlockPistonComponent") @val
  external componentId: string = "componentId"
  @send external getAttachedBlocks: t => array<_Block> = "getAttachedBlocks"
  @send external getAttachedBlocksLocations: t => array<vector3> = "getAttachedBlocksLocations"
  @get external isMoving: t => bool = "isMoving"
  @get external state: t => block_piston_state = "state"
}
...
module BlockPotionContainerComponent = {
  ...
  @module("@minecraft/server") @scope("BlockPotionContainerComponent") @val
  external componentId: string = "componentId"
...
module BlockRecordPlayerComponent = {
  ...
  @module("@minecraft/server") @scope("BlockRecordPlayerComponent") @val
  external componentId: string = "componentId"
  @send external clearRecord: t => unit = "clearRecord"
  @send external isPlaying: t => bool = "isPlaying"
  @send
  external setRecord: (t, @unwrap [#ItemType(_ItemType) | #String(string)]) => unit = "setRecord"
}
...
module BlockSignComponent = {
  ...
  @module("@minecraft/server") @scope("BlockSignComponent") @val
  external componentId: string = "componentId"
  ...
  @send @return(nullable)
  external getTextDyeColor: (t, sign_side) => option<dye_color> = "getTextDyeColor"
  @send
  external setText: (
    t,
    @unwrap [#RawMessage(raw_message) | #RawText(raw_text) | #String(string)],
    sign_side,
  ) => unit = "setText"
  @send external setTextDyeColor: (t, ~color: dye_color=?, sign_side) => unit = "setTextDyeColor"
  @send external setWaxed: (t, bool) => unit = "setWaxed"
...
module BlockSnowContainerComponent = {
  ...
  @module("@minecraft/server") @scope("BlockSnowContainerComponent") @val
  external componentId: string = "componentId"
}
...
module BlockStateType = {
  ...
  @get external id: t => string = "id"
  @get
  external validValues: t => array<@unwrap [#Boolean(bool) | #Int32(int32) | #String(string)]> =
    "validValues"
}
...
module BlockVolumeUtils = {
  ...
  @send
  external doesLocationTouchFaces: (t, block_volume, vector3) => bool = "doesLocationTouchFaces"
  @send
  external doesVolumeTouchFaces: (t, block_volume, block_volume) => bool = "doesVolumeTouchFaces"
  @send external equals: (t, block_volume, block_volume) => bool = "equals"
  @send
  external getBlockLocationIterator: (t, block_volume) => _BlockLocationIterator =
  ...
  @send
  external intersects: (t, block_volume, block_volume) => block_volume_intersection = "intersects"
...
module BlockWaterContainerComponent = {
  ...
  @module("@minecraft/server") @scope("BlockWaterContainerComponent") @val
  external componentId: string = "componentId"
...
module BoundingBoxUtils = {
  ...
  @send @return(nullable)
  external getIntersection: (t, bounding_box, bounding_box) => option<bounding_box> =
    "getIntersection"
...
module ButtonPushAfterEventSignal = {
  ...
  include IButtonPushAfterEventSignal.Impl({
    type t = t
  })
}
...
module Camera = {
  ...
  @send external fade: (t, ~fadeCameraOptions: camera_fade_options=?) => unit = "fade"
  @send
  external setCamera: (
    t,
    string,
    ~setOptions: option<
      @unwrap
      [
        | #CameraDefaultOptions(camera_default_options)
        | #CameraSetFacingOptions(camera_set_facing_options)
        | #CameraSetLocationOptions(camera_set_location_options)
        | #CameraSetPosOptions(camera_set_pos_options)
        | #CameraSetRotOptions(camera_set_rot_options)
      ],
    >=?,
  ) => unit = "setCamera"
}
...
module ChatSendAfterEvent = {
  ...
  @get external sender: t => _Player = "sender"
  @get external targets: t => option<array<_Player>> = "targets"
}

module ChatSendAfterEventSignal = {
  type t = _ChatSendAfterEventSignal
  @send
  external subscribe: (t, _ChatSendAfterEvent => unit) => _ChatSendAfterEvent => unit = "subscribe"
...
module ChatSendBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _ChatSendBeforeEvent => unit) => _ChatSendBeforeEvent => unit =
    "subscribe"
...
module CompoundBlockVolume = {
  ...
  @send @return(nullable)
  external peekLastVolume: (
    t,
    ~forceRelativity: compound_block_volume_position_relativity=?,
  ) => option<compound_block_volume_item> = "peekLastVolume"
  @send external popVolume: t => bool = "popVolume"
  @send external pushVolume: (t, compound_block_volume_item) => unit = "pushVolume"
  @send
  external replaceOrAddLastVolume: (t, compound_block_volume_item) => bool =
    "replaceOrAddLastVolume"
  @send external setOrigin: (t, vector3, ~preserveExistingVolumes: bool=?) => unit = "setOrigin"
  @send
  external translateOrigin: (t, vector3, ~preserveExistingVolumes: bool=?) => unit =
    "translateOrigin"
...
module Container = {
  ...
  @send external setItem: (t, int32, ~itemStack: _ItemStack=?) => unit = "setItem"
  @send external swapItems: (t, int32, int32, t) => unit = "swapItems"
  @send @return(nullable)
  external transferItem: (t, int32, t) => option<_ItemStack> = "transferItem"
...
module ContainerSlot = {
  ...
  external getDynamicProperty: (
    ...
    @unwrap [#Boolean(bool) | #Double(float) | #Float(float) | #String(string) | #Vector3(vector3)],
  > = "getDynamicProperty"
  ...
  @send external getTags: t => array<string> = "getTags"
  @send external hasItem: t => bool = "hasItem"
  @send external hasTag: (t, string) => bool = "hasTag"
  @send external isStackableWith: (t, _ItemStack) => bool = "isStackableWith"
  @send external isValid: t => bool = "isValid"
  @send external setCanDestroy: (t, ~blockIdentifiers: array<string>=?) => unit = "setCanDestroy"
  @send external setCanPlaceOn: (t, ~blockIdentifiers: array<string>=?) => unit = "setCanPlaceOn"
  @send
  external setDynamicProperty: (
    t,
    string,
  ...
  @send external setItem: (t, ~itemStack: _ItemStack=?) => unit = "setItem"
  @send external setLore: (t, ~loreList: array<string>=?) => unit = "setLore"
...
module DataDrivenEntityTriggerAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _DataDrivenEntityTriggerAfterEvent => unit,
    ~options: entity_data_driven_trigger_event_options=?,
  ) => _DataDrivenEntityTriggerAfterEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _DataDrivenEntityTriggerAfterEvent => unit) => unit = "unsubscribe"
}
...
module DataDrivenEntityTriggerBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _DataDrivenEntityTriggerBeforeEvent => unit,
    ~options: entity_data_driven_trigger_event_options=?,
  ) => _DataDrivenEntityTriggerBeforeEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _DataDrivenEntityTriggerBeforeEvent => unit) => unit = "unsubscribe"
}

module Dimension = {
  type t = _Dimension
  @send
  external createExplosion: (t, vector3, float, ~explosionOptions: explosion_options=?) => bool =
    "createExplosion"
  @send
  external fillBlocks: (
    t,
    ...
    vector3,
    @unwrap [#BlockPermutation(_BlockPermutation) | #BlockType(_BlockType) | #String(string)],
    ~options: block_fill_options=?,
  ) => int32 = "fillBlocks"
  @send @return(nullable)
  external findClosestBiome: (
    t,
    vector3,
    @unwrap [#BiomeType(_BiomeType) | #String(string)],
    ~options: biome_search_options=?,
  ) => option<vector3> = "findClosestBiome"
  @send @return(nullable) external getBlock: (t, vector3) => option<_Block> = "getBlock"
  @send @return(nullable)
  external getBlockFromRay: (
    t,
    vector3,
    vector3,
    ~options: block_raycast_options=?,
  ) => option<block_raycast_hit> = "getBlockFromRay"
  @send
  external getEntities: (t, ~options: entity_query_options=?) => array<_Entity> = "getEntities"
  @send
  external getEntitiesAtBlockLocation: (t, vector3) => array<_Entity> = "getEntitiesAtBlockLocation"
  @send
  external getEntitiesFromRay: (
    t,
    vector3,
    vector3,
    ~options: entity_raycast_options=?,
  ) => array<entity_raycast_hit> = "getEntitiesFromRay"
  @send external getPlayers: (t, ~options: entity_query_options=?) => array<_Player> = "getPlayers"
  ...
  @send external setWeather: (t, weather_type, ~duration: int32=?) => unit = "setWeather"
  ...
  @send
  external spawnParticle: (t, string, vector3, ~molangVariables: _MolangVariableMap=?) => unit =
    "spawnParticle"
...
module EffectAddAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EffectAddAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EffectAddAfterEvent => unit = "subscribe"
...
module EffectAddBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _EffectAddBeforeEvent => unit) => _EffectAddBeforeEvent => unit =
    "subscribe"
...
module EntityAddRiderComponent = {
  ...
  @module("@minecraft/server") @scope("EntityAddRiderComponent") @val
  external componentId: string = "componentId"
...
module EntityAgeableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityAgeableComponent") @val
  external componentId: string = "componentId"
...
module EntityBreathableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityBreathableComponent") @val
  external componentId: string = "componentId"
...
module EntityCanClimbComponent = {
  ...
  @module("@minecraft/server") @scope("EntityCanClimbComponent") @val
  external componentId: string = "componentId"
}
...
module EntityCanFlyComponent = {
  ...
  @module("@minecraft/server") @scope("EntityCanFlyComponent") @val
  external componentId: string = "componentId"
}
...
module EntityCanPowerJumpComponent = {
  ...
  @module("@minecraft/server") @scope("EntityCanPowerJumpComponent") @val
  external componentId: string = "componentId"
}
...
module EntityColorComponent = {
  ...
  @module("@minecraft/server") @scope("EntityColorComponent") @val
  external componentId: string = "componentId"
...
module EntityDieAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityDieAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityDieAfterEvent => unit = "subscribe"
...
module EntityEquippableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityEquippableComponent") @val
  external componentId: string = "componentId"
  @send @return(nullable)
  external getEquipment: (t, equipment_slot) => option<_ItemStack> = "getEquipment"
  @send external getEquipmentSlot: (t, equipment_slot) => _ContainerSlot = "getEquipmentSlot"
  @send
  external setEquipment: (t, equipment_slot, ~itemStack: _ItemStack=?) => bool = "setEquipment"
}
...
module EntityFireImmuneComponent = {
  ...
  @module("@minecraft/server") @scope("EntityFireImmuneComponent") @val
  external componentId: string = "componentId"
}
...
module EntityFloatsInLiquidComponent = {
  ...
  @module("@minecraft/server") @scope("EntityFloatsInLiquidComponent") @val
  external componentId: string = "componentId"
}
...
module EntityFlyingSpeedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityFlyingSpeedComponent") @val
  external componentId: string = "componentId"
...
module EntityFrictionModifierComponent = {
  ...
  @module("@minecraft/server") @scope("EntityFrictionModifierComponent") @val
  external componentId: string = "componentId"
  @get external value: t => float = "value"
  @set external setValue: (t, float) => unit = "value"
}
...
module EntityGroundOffsetComponent = {
  ...
  @module("@minecraft/server") @scope("EntityGroundOffsetComponent") @val
  external componentId: string = "componentId"
  @get external value: t => float = "value"
  @set external setValue: (t, float) => unit = "value"
}
...
module EntityHealableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityHealableComponent") @val
  external componentId: string = "componentId"
...
module EntityHealthChangedAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityHealthChangedAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityHealthChangedAfterEvent => unit = "subscribe"
...
module EntityHealthComponent = {
  ...
  include EntityAttributeComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("EntityHealthComponent") @val
  external componentId: string = "componentId"
}
...
module EntityHitBlockAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityHitBlockAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityHitBlockAfterEvent => unit = "subscribe"
...
module EntityHitEntityAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityHitEntityAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityHitEntityAfterEvent => unit = "subscribe"
...
module EntityHurtAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityHurtAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityHurtAfterEvent => unit = "subscribe"
...
module EntityInventoryComponent = {
  ...
  @module("@minecraft/server") @scope("EntityInventoryComponent") @val
  external componentId: string = "componentId"
...
module EntityIsBabyComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsBabyComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsChargedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsChargedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsChestedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsChestedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsDyeableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsDyeableComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsHiddenWhenInvisibleComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsHiddenWhenInvisibleComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsIgnitedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsIgnitedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsIllagerCaptainComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsIllagerCaptainComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsSaddledComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsSaddledComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsShakingComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsShakingComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsShearedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsShearedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsStackableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsStackableComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsStunnedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsStunnedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityIsTamedComponent = {
  ...
  @module("@minecraft/server") @scope("EntityIsTamedComponent") @val
  external componentId: string = "componentId"
}
...
module EntityItemComponent = {
  ...
  @module("@minecraft/server") @scope("EntityItemComponent") @val
  external componentId: string = "componentId"
...
module EntityLavaMovementComponent = {
  ...
  @module("@minecraft/server") @scope("EntityLavaMovementComponent") @val
  external componentId: string = "componentId"
}
...
module EntityLeashableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityLeashableComponent") @val
  external componentId: string = "componentId"
...
module EntityLoadAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _EntityLoadAfterEvent => unit) => _EntityLoadAfterEvent => unit =
    "subscribe"
...
module EntityMarkVariantComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMarkVariantComponent") @val
  external componentId: string = "componentId"
  @get external value: t => int32 = "value"
  @set external setValue: (t, int32) => unit = "value"
}
...
module EntityMountTamingComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMountTamingComponent") @val
  external componentId: string = "componentId"
...
module EntityMovementAmphibiousComponent = {
  ...
  include EntityBaseMovementComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("EntityMovementAmphibiousComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementBasicComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementBasicComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementFlyComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementFlyComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementGenericComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementGenericComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementGlideComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementGlideComponent") @val
  external componentId: string = "componentId"
...
module EntityMovementHoverComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementHoverComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementJumpComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementJumpComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementSkipComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementSkipComponent") @val
  external componentId: string = "componentId"
}
...
module EntityMovementSwayComponent = {
  ...
  @module("@minecraft/server") @scope("EntityMovementSwayComponent") @val
  external componentId: string = "componentId"
...
module EntityNavigationClimbComponent = {
  ...
  include EntityNavigationComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("EntityNavigationClimbComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNavigationFloatComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNavigationFloatComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNavigationFlyComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNavigationFlyComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNavigationGenericComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNavigationGenericComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNavigationHoverComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNavigationHoverComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNavigationWalkComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNavigationWalkComponent") @val
  external componentId: string = "componentId"
}
...
module EntityNpcComponent = {
  ...
  @module("@minecraft/server") @scope("EntityNpcComponent") @val
  external componentId: string = "componentId"
...
module EntityOnFireComponent = {
  ...
  @module("@minecraft/server") @scope("EntityOnFireComponent") @val
  external componentId: string = "componentId"
  @get external onFireTicksRemaining: t => int32 = "onFireTicksRemaining"
}

module EntityProjectileComponent = {
  type t = _EntityProjectileComponent
  include EntityComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("EntityProjectileComponent") @val
  external componentId: string = "componentId"
  @send external shoot: (t, vector3, ~options: projectile_shoot_options=?) => unit = "shoot"
  @get external airInertia: t => float = "airInertia"
  @get external catchFireOnHurt: t => bool = "catchFireOnHurt"
  @get external critParticlesOnProjectileHurt: t => bool = "critParticlesOnProjectileHurt"
  @get external destroyOnProjectileHurt: t => bool = "destroyOnProjectileHurt"
  @get external gravity: t => float = "gravity"
  @get external hitEntitySound: t => option<string> = "hitEntitySound"
  @get external hitGroundSound: t => option<string> = "hitGroundSound"
  @get external hitParticle: t => option<string> = "hitParticle"
  @get external lightningStrikeOnHit: t => bool = "lightningStrikeOnHit"
  @get external liquidInertia: t => float = "liquidInertia"
  @get external onFireTime: t => float = "onFireTime"
  @get external owner: t => option<_Entity> = "owner"
  @get external shouldBounceOnHit: t => bool = "shouldBounceOnHit"
  @get external stopOnHit: t => bool = "stopOnHit"
  @set external setAirInertia: (t, float) => unit = "airInertia"
  @set external setCatchFireOnHurt: (t, bool) => unit = "catchFireOnHurt"
  @set
  external setCritParticlesOnProjectileHurt: (t, bool) => unit = "critParticlesOnProjectileHurt"
  @set external setDestroyOnProjectileHurt: (t, bool) => unit = "destroyOnProjectileHurt"
  @set external setGravity: (t, float) => unit = "gravity"
  @set external setHitEntitySound: (t, option<string>) => unit = "hitEntitySound"
  @set external setHitGroundSound: (t, option<string>) => unit = "hitGroundSound"
  @set external setHitParticle: (t, option<string>) => unit = "hitParticle"
  @set external setLightningStrikeOnHit: (t, bool) => unit = "lightningStrikeOnHit"
  @set external setLiquidInertia: (t, float) => unit = "liquidInertia"
  @set external setOnFireTime: (t, float) => unit = "onFireTime"
  @set external setOwner: (t, option<_Entity>) => unit = "owner"
  @set external setShouldBounceOnHit: (t, bool) => unit = "shouldBounceOnHit"
  @set external setStopOnHit: (t, bool) => unit = "stopOnHit"
}
...
module EntityPushThroughComponent = {
  ...
  @module("@minecraft/server") @scope("EntityPushThroughComponent") @val
  external componentId: string = "componentId"
  @get external value: t => float = "value"
  @set external setValue: (t, float) => unit = "value"
}
...
module EntityRemoveAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _EntityRemoveAfterEvent => unit,
    ~options: entity_event_options=?,
  ) => _EntityRemoveAfterEvent => unit = "subscribe"
...
module EntityRemoveBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _EntityRemoveBeforeEvent => unit) => _EntityRemoveBeforeEvent => unit =
    "subscribe"
...
module EntityRideableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityRideableComponent") @val
  external componentId: string = "componentId"
...
module EntityRidingComponent = {
  ...
  @module("@minecraft/server") @scope("EntityRidingComponent") @val
  external componentId: string = "componentId"
...
module EntityScaleComponent = {
  ...
  @module("@minecraft/server") @scope("EntityScaleComponent") @val
  external componentId: string = "componentId"
  @get external value: t => float = "value"
  @set external setValue: (t, float) => unit = "value"
}
...
module EntitySkinIdComponent = {
  ...
  @module("@minecraft/server") @scope("EntitySkinIdComponent") @val
  external componentId: string = "componentId"
  @get external value: t => int32 = "value"
  @set external setValue: (t, int32) => unit = "value"
}
...
module EntitySpawnAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _EntitySpawnAfterEvent => unit) => _EntitySpawnAfterEvent => unit =
    "subscribe"
...
module EntityStrengthComponent = {
  ...
  @module("@minecraft/server") @scope("EntityStrengthComponent") @val
  external componentId: string = "componentId"
...
module EntityTameableComponent = {
  ...
  @module("@minecraft/server") @scope("EntityTameableComponent") @val
  external componentId: string = "componentId"
...
module EntityTypes = {
  ...
  @send external getAll: t => array<_EntityType> = "getAll"
}
...
module EntityUnderwaterMovementComponent = {
  ...
  @module("@minecraft/server") @scope("EntityUnderwaterMovementComponent") @val
  external componentId: string = "componentId"
}
...
module EntityVariantComponent = {
  ...
  @module("@minecraft/server") @scope("EntityVariantComponent") @val
  external componentId: string = "componentId"
  @get external value: t => int32 = "value"
}
...
module EntityWantsJockeyComponent = {
  ...
  @module("@minecraft/server") @scope("EntityWantsJockeyComponent") @val
  external componentId: string = "componentId"
}
...
module ExplosionAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ExplosionAfterEvent => unit) => _ExplosionAfterEvent => unit =
    "subscribe"
...
module ExplosionBeforeEvent = {
  ...
  include ExplosionAfterEvent.Impl({
    type t = t
  })
...
module ExplosionBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _ExplosionBeforeEvent => unit) => _ExplosionBeforeEvent => unit =
    "subscribe"
...
module FluidContainer = {
  ...
  @module("@minecraft/server") @scope("FluidContainer") @val
  external maxFillLevel: int32 = "maxFillLevel"
  @module("@minecraft/server") @scope("FluidContainer") @val
  external minFillLevel: int32 = "minFillLevel"
}
...
module ItemCompleteUseAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _ItemCompleteUseAfterEvent => unit,
  ) => _ItemCompleteUseAfterEvent => unit = "subscribe"
...
module ItemCooldownComponent = {
  ...
  include ItemComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("ItemCooldownComponent") @val
  external componentId: string = "componentId"
...
module ItemDefinitionAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _ItemDefinitionTriggeredAfterEvent => unit,
  ) => _ItemDefinitionTriggeredAfterEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _ItemDefinitionTriggeredAfterEvent => unit) => unit = "unsubscribe"
}
...
module ItemDefinitionBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _ItemDefinitionTriggeredBeforeEvent => unit,
  ) => _ItemDefinitionTriggeredBeforeEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _ItemDefinitionTriggeredBeforeEvent => unit) => unit = "unsubscribe"
}

module ItemDefinitionTriggeredBeforeEvent = {
  type t = _ItemDefinitionTriggeredBeforeEvent
  include ItemDefinitionTriggeredAfterEvent.Impl({
    type t = t
  })
  @get external cancel: t => bool = "cancel"
  @set external setCancel: (t, bool) => unit = "cancel"
...
module ItemDurabilityComponent = {
  ...
  @module("@minecraft/server") @scope("ItemDurabilityComponent") @val
  external componentId: string = "componentId"
  @send external getDamageChance: (t, int32) => int32 = "getDamageChance"
  @send external getDamageChanceRange: t => number_range = "getDamageChanceRange"
...
module ItemEnchantableComponent = {
  type t = _ItemEnchantableComponent
  include ItemComponent.Impl({
    type t = t
  })
  @module("@minecraft/server") @scope("ItemEnchantableComponent") @val
  external componentId: string = "componentId"
  @send external addEnchantment: (t, enchantment) => unit = "addEnchantment"
  @send external addEnchantments: (t, array<enchantment>) => unit = "addEnchantments"
  @send external canAddEnchantment: (t, enchantment) => bool = "canAddEnchantment"
  @send @return(nullable)
  external getEnchantment: (
    t,
    @unwrap [#EnchantmentType(_EnchantmentType) | #String(string)],
  ) => option<enchantment> = "getEnchantment"
  @send external getEnchantments: t => array<enchantment> = "getEnchantments"
  @send
  external hasEnchantment: (
    t,
    @unwrap [#EnchantmentType(_EnchantmentType) | #String(string)],
  ) => bool = "hasEnchantment"
  @send external removeAllEnchantments: t => unit = "removeAllEnchantments"
  @send
  external removeEnchantment: (
    t,
    @unwrap [#EnchantmentType(_EnchantmentType) | #String(string)],
  ) => unit = "removeEnchantment"
}
...
module ItemFoodComponent = {
  ...
  @module("@minecraft/server") @scope("ItemFoodComponent") @val
  external componentId: string = "componentId"
...
module ItemReleaseUseAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemReleaseUseAfterEvent => unit) => _ItemReleaseUseAfterEvent => unit =
    "subscribe"
...
module ItemStack = {
  ...
  @send external getCanPlaceOn: t => array<string> = "getCanPlaceOn"
  @send @return(nullable)
  external getComponent: (t, string) => option<_ItemComponent> = "getComponent"
...
module ItemStartUseAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemStartUseAfterEvent => unit) => _ItemStartUseAfterEvent => unit =
    "subscribe"
...
module ItemStartUseOnAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemStartUseOnAfterEvent => unit) => _ItemStartUseOnAfterEvent => unit =
    "subscribe"
...
module ItemStopUseAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemStopUseAfterEvent => unit) => _ItemStopUseAfterEvent => unit =
    "subscribe"
...
module ItemStopUseOnAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemStopUseOnAfterEvent => unit) => _ItemStopUseOnAfterEvent => unit =
    "subscribe"
...
module ItemUseBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemUseBeforeEvent => unit) => _ItemUseBeforeEvent => unit = "subscribe"
...
module ItemUseOnAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemUseOnAfterEvent => unit) => _ItemUseOnAfterEvent => unit =
    "subscribe"
...
module ItemUseOnBeforeEvent = {
  ...
  include ItemUseOnAfterEvent.Impl({
    type t = t
  })
  @get external cancel: t => bool = "cancel"
  @set external setCancel: (t, bool) => unit = "cancel"
...
module ItemUseOnBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _ItemUseOnBeforeEvent => unit) => _ItemUseOnBeforeEvent => unit =
    "subscribe"
...
module LeverActionAfterEventSignal = {
  ...
  include ILeverActionAfterEventSignal.Impl({
    type t = t
  })
}
...
module MinecraftDimensionTypes = {
  ...
  @module("@minecraft/server") @scope("MinecraftDimensionTypes") @val
  external nether: string = "nether"
  @module("@minecraft/server") @scope("MinecraftDimensionTypes") @val
  external overworld: string = "overworld"
  @module("@minecraft/server") @scope("MinecraftDimensionTypes") @val
  external theEnd: string = "theEnd"
}
...
module MolangVariableMap = {
  ...
  @new external make: unit => t = "MolangVariableMap"
}
...
module PistonActivateAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _PistonActivateAfterEvent => unit) => _PistonActivateAfterEvent => unit =
    "subscribe"
...
module Player = {
  ...
  @send external eatItem: (t, _ItemStack) => unit = "eatItem"
  ...
  @send external playMusic: (t, string, ~musicOptions: music_options=?) => unit = "playMusic"
  @send external playSound: (t, string, ~soundOptions: player_sound_options=?) => unit = "playSound"
  @send external postClientMessage: (t, string, string) => unit = "postClientMessage"
  @send external queueMusic: (t, string, ~musicOptions: music_options=?) => unit = "queueMusic"
  ...
  @send external setSpawnPoint: (t, ~spawnPoint: dimension_location=?) => unit = "setSpawnPoint"
  @send
  external spawnParticle: (t, string, vector3, ~molangVariables: _MolangVariableMap=?) => unit =
    "spawnParticle"
...
module PlayerBreakBlockAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerBreakBlockAfterEvent => unit,
    ~options: block_event_options=?,
  ) => _PlayerBreakBlockAfterEvent => unit = "subscribe"
...
module PlayerBreakBlockBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerBreakBlockBeforeEvent => unit,
    ~options: block_event_options=?,
  ) => _PlayerBreakBlockBeforeEvent => unit = "subscribe"
...
module PlayerDimensionChangeAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerDimensionChangeAfterEvent => unit,
  ) => _PlayerDimensionChangeAfterEvent => unit = "subscribe"
...
module PlayerInteractWithBlockAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerInteractWithBlockAfterEvent => unit,
  ) => _PlayerInteractWithBlockAfterEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _PlayerInteractWithBlockAfterEvent => unit) => unit = "unsubscribe"
}
...
module PlayerInteractWithBlockBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerInteractWithBlockBeforeEvent => unit,
  ) => _PlayerInteractWithBlockBeforeEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _PlayerInteractWithBlockBeforeEvent => unit) => unit = "unsubscribe"
}
...
module PlayerInteractWithEntityAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerInteractWithEntityAfterEvent => unit,
  ) => _PlayerInteractWithEntityAfterEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _PlayerInteractWithEntityAfterEvent => unit) => unit = "unsubscribe"
}
...
module PlayerInteractWithEntityBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerInteractWithEntityBeforeEvent => unit,
  ) => _PlayerInteractWithEntityBeforeEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _PlayerInteractWithEntityBeforeEvent => unit) => unit = "unsubscribe"
}
...
module PlayerJoinAfterEventSignal = {
  ...
  include IPlayerJoinAfterEventSignal.Impl({
    type t = t
  })
}
...
module PlayerLeaveAfterEventSignal = {
  ...
  include IPlayerLeaveAfterEventSignal.Impl({
    type t = t
  })
}
...
module PlayerLeaveBeforeEventSignal = {
  ...
  @send
  external subscribe: (t, _PlayerLeaveBeforeEvent => unit) => _PlayerLeaveBeforeEvent => unit =
    "subscribe"
...
module PlayerPlaceBlockAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerPlaceBlockAfterEvent => unit,
    ~options: block_event_options=?,
  ) => _PlayerPlaceBlockAfterEvent => unit = "subscribe"
...
module PlayerPlaceBlockBeforeEvent = {
  ...
  @get external faceLocation: t => vector3 = "faceLocation"
  @get external permutationBeingPlaced: t => _BlockPermutation = "permutationBeingPlaced"
  @get external player: t => _Player = "player"
  @set external setCancel: (t, bool) => unit = "cancel"
}
...
module PlayerPlaceBlockBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _PlayerPlaceBlockBeforeEvent => unit,
    ~options: block_event_options=?,
  ) => _PlayerPlaceBlockBeforeEvent => unit = "subscribe"
...
module PlayerSpawnAfterEventSignal = {
  ...
  include IPlayerSpawnAfterEventSignal.Impl({
    type t = t
  })
}
...
module PressurePlatePopAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PressurePlatePopAfterEvent => unit,
  ) => _PressurePlatePopAfterEvent => unit = "subscribe"
...
module PressurePlatePushAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _PressurePlatePushAfterEvent => unit,
  ) => _PressurePlatePushAfterEvent => unit = "subscribe"
...
module ProjectileHitBlockAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _ProjectileHitBlockAfterEvent => unit,
  ) => _ProjectileHitBlockAfterEvent => unit = "subscribe"
...
module ProjectileHitEntityAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _ProjectileHitEntityAfterEvent => unit,
  ) => _ProjectileHitEntityAfterEvent => unit = "subscribe"
...
module Scoreboard = {
  type t = _Scoreboard
  @send
  external addObjective: (t, string, ~displayName: string=?) => _ScoreboardObjective =
    "addObjective"
  @send @return(nullable)
  external clearObjectiveAtDisplaySlot: (t, display_slot_id) => option<_ScoreboardObjective> =
    "clearObjectiveAtDisplaySlot"
  @send @return(nullable)
  external getObjective: (t, string) => option<_ScoreboardObjective> = "getObjective"
  @send @return(nullable)
  external getObjectiveAtDisplaySlot: (
    t,
    display_slot_id,
  ) => option<scoreboard_objective_display_options> = "getObjectiveAtDisplaySlot"
  ...
  @send
  external removeObjective: (
    t,
    @unwrap [#ScoreboardObjective(_ScoreboardObjective) | #String(string)],
  ) => bool = "removeObjective"
  @send @return(nullable)
  external setObjectiveAtDisplaySlot: (
    t,
    display_slot_id,
    scoreboard_objective_display_options,
  ) => option<_ScoreboardObjective> = "setObjectiveAtDisplaySlot"
}
...
module ScoreboardObjective = {
  ...
  external addScore: (
    t,
    @unwrap [#Entity(_Entity) | #ScoreboardIdentity(_ScoreboardIdentity) | #String(string)],
    int32,
  ) => int32 = "addScore"
  @send external getParticipants: t => array<_ScoreboardIdentity> = "getParticipants"
  @send @return(nullable)
  external getScore: (
    t,
    @unwrap [#Entity(_Entity) | #ScoreboardIdentity(_ScoreboardIdentity) | #String(string)],
  ) => option<int32> = "getScore"
  @send external getScores: t => array<_ScoreboardScoreInfo> = "getScores"
  @send
  external hasParticipant: (
    t,
    @unwrap [#Entity(_Entity) | #ScoreboardIdentity(_ScoreboardIdentity) | #String(string)],
  ) => bool = "hasParticipant"
  @send external isValid: t => bool = "isValid"
  @send
  external removeParticipant: (
    t,
    @unwrap [#Entity(_Entity) | #ScoreboardIdentity(_ScoreboardIdentity) | #String(string)],
...
module ScriptEventCommandMessageAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _ScriptEventCommandMessageAfterEvent => unit,
    ~options: script_event_message_filter_options=?,
  ) => _ScriptEventCommandMessageAfterEvent => unit = "subscribe"
  @send
  external unsubscribe: (t, _ScriptEventCommandMessageAfterEvent => unit) => unit = "unsubscribe"
}
...
module ServerMessageAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _MessageReceiveAfterEvent => unit) => _MessageReceiveAfterEvent => unit =
    "subscribe"
...
module System = {
  type t = _System
  @send external clearJob: (t, int32) => unit = "clearJob"
  @send external clearRun: (t, int32) => unit = "clearRun"
  @send external run: (t, unit => unit) => int32 = "run"
  @send external runInterval: (t, unit => unit, ~tickInterval: int32=?) => int32 = "runInterval"
  @send external runTimeout: (t, unit => unit, ~tickDelay: int32=?) => int32 = "runTimeout"
...
module SystemAfterEvents = {
  ...
  @get
  external scriptEventReceive: t => _ScriptEventCommandMessageAfterEventSignal =
    "scriptEventReceive"
}
...
module TargetBlockHitAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _TargetBlockHitAfterEvent => unit) => _TargetBlockHitAfterEvent => unit =
    "subscribe"
...
module TripWireTripAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _TripWireTripAfterEvent => unit) => _TripWireTripAfterEvent => unit =
    "subscribe"
...
module Vector = {
  ...
  @send
  external multiply: (t, vector3, @unwrap [#Float(float) | #Vector3(vector3)]) => t = "multiply"
...
module WatchdogTerminateBeforeEventSignal = {
  ...
  external subscribe: (
    t,
    _WatchdogTerminateBeforeEvent => unit,
  ) => _WatchdogTerminateBeforeEvent => unit = "subscribe"
...
module WeatherChangeAfterEventSignal = {
  ...
  @send
  external subscribe: (t, _WeatherChangeAfterEvent => unit) => _WeatherChangeAfterEvent => unit =
    "subscribe"
  @send external unsubscribe: (t, _WeatherChangeAfterEvent => unit) => unit = "unsubscribe"
}

module WeatherChangeBeforeEvent = {
  type t = _WeatherChangeBeforeEvent
  @get external cancel: t => bool = "cancel"
  @get external duration: t => int32 = "duration"
  @get external newWeather: t => weather_type = "newWeather"
  @get external previousWeather: t => weather_type = "previousWeather"
  @set external setCancel: (t, bool) => unit = "cancel"
  @set external setDuration: (t, int32) => unit = "duration"
  @set external setNewWeather: (t, weather_type) => unit = "newWeather"
}

module WeatherChangeBeforeEventSignal = {
  type t = _WeatherChangeBeforeEventSignal
  @send
  external subscribe: (t, _WeatherChangeBeforeEvent => unit) => _WeatherChangeBeforeEvent => unit =
    "subscribe"
  @send external unsubscribe: (t, _WeatherChangeBeforeEvent => unit) => unit = "unsubscribe"
}
...
module World = {
  ...
  @send external playMusic: (t, string, ~musicOptions: music_options=?) => unit = "playMusic"
  @send
  external playSound: (t, string, vector3, ~soundOptions: world_sound_options=?) => unit =
    "playSound"
  @send external queueMusic: (t, string, ~musicOptions: music_options=?) => unit = "queueMusic"
  @send
  external sendMessage: (
  ...
  @send
  external setTimeOfDay: (t, @unwrap [#Int32(int32) | #TimeOfDay(time_of_day)]) => unit =
    "setTimeOfDay"
  @send external stopMusic: t => unit = "stopMusic"
...
module WorldAfterEvents = {
  ...
  @get
  external dataDrivenEntityTrigger: t => _DataDrivenEntityTriggerAfterEventSignal =
  ...
  @get
  external entityHealthChanged: t => _EntityHealthChangedAfterEventSignal = "entityHealthChanged"
  ...
  @get
  external playerDimensionChange: t => _PlayerDimensionChangeAfterEventSignal =
    "playerDimensionChange"
  @get
  external playerInteractWithBlock: t => _PlayerInteractWithBlockAfterEventSignal =
    "playerInteractWithBlock"
  @get
  external playerInteractWithEntity: t => _PlayerInteractWithEntityAfterEventSignal =
  ...
  @get
  external projectileHitEntity: t => _ProjectileHitEntityAfterEventSignal = "projectileHitEntity"
...
module WorldBeforeEvents = {
  ...
  @get
  external dataDrivenEntityTriggerEvent: t => _DataDrivenEntityTriggerBeforeEventSignal =
  ...
  @get
  external playerInteractWithBlock: t => _PlayerInteractWithBlockBeforeEventSignal =
    "playerInteractWithBlock"
  @get
  external playerInteractWithEntity: t => _PlayerInteractWithEntityBeforeEventSignal =
    "playerInteractWithEntity"
  ...
  @get external weatherChange: t => _WeatherChangeBeforeEventSignal = "weatherChange"
}
...
module WorldInitializeAfterEventSignal = {
  ...
  external subscribe: (
    t,
    _WorldInitializeAfterEvent => unit,
  ) => _WorldInitializeAfterEvent => unit = "subscribe"
...
module BlockComponentTypeMap = {
  ...
  external toBlockLavaContainerComponent: _BlockComponent => _BlockLavaContainerComponent =
    "%identity"
  external toBlockPotionContainerComponent: _BlockComponent => _BlockPotionContainerComponent =
    "%identity"
  external toBlockSnowContainerComponent: _BlockComponent => _BlockSnowContainerComponent =
    "%identity"
  external toBlockWaterContainerComponent: _BlockComponent => _BlockWaterContainerComponent =
    "%identity"
  external toBlockRecordPlayerComponent: _BlockComponent => _BlockRecordPlayerComponent =
    "%identity"
}
...
module EntityComponentTypeMap = {
  ...
  external toEntityMountTamingComponent: _EntityComponent => _EntityMountTamingComponent =
    "%identity"
  ...
  external toEntityProjectileComponent: _EntityComponent => _EntityProjectileComponent = "%identity"
  ...
  external toEntityCanPowerJumpComponent: _EntityComponent => _EntityCanPowerJumpComponent =
    "%identity"
  external toEntityFireImmuneComponent: _EntityComponent => _EntityFireImmuneComponent = "%identity"
  external toEntityFloatsInLiquidComponent: _EntityComponent => _EntityFloatsInLiquidComponent =
    "%identity"
  ...
  external toEntityIsHiddenWhenInvisibleComponent: _EntityComponent => _EntityIsHiddenWhenInvisibleComponent =
    "%identity"
  external toEntityIsIgnitedComponent: _EntityComponent => _EntityIsIgnitedComponent = "%identity"
  external toEntityIsIllagerCaptainComponent: _EntityComponent => _EntityIsIllagerCaptainComponent =
    "%identity"
  ...
  external toEntityIsStackableComponent: _EntityComponent => _EntityIsStackableComponent =
    "%identity"
  ...
  external toEntityWantsJockeyComponent: _EntityComponent => _EntityWantsJockeyComponent =
    "%identity"
  external toEntityColorComponent: _EntityComponent => _EntityColorComponent = "%identity"
  external toEntityFlyingSpeedComponent: _EntityComponent => _EntityFlyingSpeedComponent =
    "%identity"
  external toEntityFrictionModifierComponent: _EntityComponent => _EntityFrictionModifierComponent =
    "%identity"
  external toEntityGroundOffsetComponent: _EntityComponent => _EntityGroundOffsetComponent =
    "%identity"
  external toEntityMarkVariantComponent: _EntityComponent => _EntityMarkVariantComponent =
    "%identity"
  external toEntityPushThroughComponent: _EntityComponent => _EntityPushThroughComponent =
    "%identity"
  ...
  external toEntityLavaMovementComponent: _EntityComponent => _EntityLavaMovementComponent =
    "%identity"
  external toEntityMovementAmphibiousComponent: _EntityComponent => _EntityMovementAmphibiousComponent =
    "%identity"
  external toEntityMovementBasicComponent: _EntityComponent => _EntityMovementBasicComponent =
    "%identity"
  external toEntityMovementComponent: _EntityComponent => _EntityMovementComponent = "%identity"
  external toEntityMovementFlyComponent: _EntityComponent => _EntityMovementFlyComponent =
    "%identity"
  external toEntityMovementGenericComponent: _EntityComponent => _EntityMovementGenericComponent =
    "%identity"
  external toEntityMovementGlideComponent: _EntityComponent => _EntityMovementGlideComponent =
    "%identity"
  external toEntityMovementHoverComponent: _EntityComponent => _EntityMovementHoverComponent =
    "%identity"
  external toEntityMovementJumpComponent: _EntityComponent => _EntityMovementJumpComponent =
    "%identity"
  external toEntityMovementSkipComponent: _EntityComponent => _EntityMovementSkipComponent =
    "%identity"
  external toEntityMovementSwayComponent: _EntityComponent => _EntityMovementSwayComponent =
    "%identity"
  external toEntityNavigationClimbComponent: _EntityComponent => _EntityNavigationClimbComponent =
    "%identity"
  external toEntityNavigationFloatComponent: _EntityComponent => _EntityNavigationFloatComponent =
    "%identity"
  external toEntityNavigationFlyComponent: _EntityComponent => _EntityNavigationFlyComponent =
    "%identity"
  external toEntityNavigationGenericComponent: _EntityComponent => _EntityNavigationGenericComponent =
    "%identity"
  external toEntityNavigationHoverComponent: _EntityComponent => _EntityNavigationHoverComponent =
    "%identity"
  external toEntityNavigationWalkComponent: _EntityComponent => _EntityNavigationWalkComponent =
    "%identity"
  external toEntityUnderwaterMovementComponent: _EntityComponent => _EntityUnderwaterMovementComponent =
    "%identity"
}
...
module ItemComponentTypeMap = {
  ...
  external toItemEnchantableComponent: _ItemComponent => _ItemEnchantableComponent = "%identity"

...
type block_piston_state = | @as("Expanded") Expanded | @as("Expanding") Expanding | @as("Retracted") Retracted | @as("Retracting") Retracting
...
type item_component_types = | @as("minecraft:cooldown") Cooldown | @as("minecraft:durability") Durability | @as("minecraft:enchantable") Enchantable | @as("minecraft:food") Food
...
type scoreboard_objective_display_options = {objective: _ScoreboardObjective, sort_order?: objective_sort_order}
type raw_message_score = {name?: string, objective?: string}
type rec raw_message = {rawtext?: array<raw_message>, score?: raw_message_score, text?: string, translate?: string, @as("with") with_?: @unwrap[ | #Array(array<string>) | #RawMessage(raw_message) ]}
type raw_text = {rawtext?: array<raw_message>}
type entity_query_score_options = {exclude?: bool, max_score?: int32, min_score?: int32, objective?: string}
...
type explosion_options = {allow_underwater?: bool, breaks_blocks?: bool, causes_fire?: bool, source?: _Entity}
...
type entity_data_driven_trigger_event_options = {entities?: array<_Entity>, entity_types?: array<string>, event_types?: array<string>}
type entity_damage_source = {cause: entity_damage_cause, damaging_entity?: _Entity, damaging_projectile?: _Entity}
type entity_apply_damage_options = {cause: entity_damage_cause, damaging_entity?: _Entity}
type entity_apply_damage_by_projectile_options = {damaging_entity?: _Entity, damaging_projectile: _Entity}
...
type teleport_options = {check_for_blocks?: bool, dimension?: _Dimension, facing_location?: vector3, keep_velocity?: bool, rotation?: vector2}
type player_sound_options = {location?: vector3, pitch?: float, volume?: float}
type entity_query_options = {closest?: int32, exclude_families?: array<string>, exclude_game_modes?: array<game_mode>, exclude_names?: array<string>, exclude_tags?: array<string>, exclude_types?: array<string>, families?: array<string>, farthest?: int32, game_mode?: game_mode, location?: vector3, max_distance?: float, max_horizontal_rotation?: float, max_level?: int32, max_vertical_rotation?: float, min_distance?: float, min_horizontal_rotation?: float, min_level?: int32, min_vertical_rotation?: float, name?: string, score_options?: array<entity_query_score_options>, tags?: array<string>, @as("type") type_?: string, volume?: _BlockAreaSize}
type camera_set_rot_options = {ease_options?: camera_ease_options, location?: vector3, rotation: vector2}
type camera_set_pos_options = {ease_options?: camera_ease_options, facing_location: vector3, location?: vector3}
type camera_set_location_options = {ease_options?: camera_ease_options, location: vector3}
type camera_set_facing_options = {ease_options?: camera_ease_options, facing_entity: _Entity, location?: vector3}
type bounding_box = {max: vector3, min: vector3}
type block_volume = {from: vector3, to: vector3}
type compound_block_volume_item = {action?: compound_block_volume_action, location_relativity?: compound_block_volume_position_relativity, volume: block_volume}
...
type block_raycast_options = {include_liquid_blocks?: bool, include_passable_blocks?: bool, max_distance?: int32}
type enchantment = {level: int32, @as("type") type_: @unwrap[ | #EnchantmentType(_EnchantmentType) | #String(string) ]}
...
type play_animation_options = {blend_out_time?: float, controller?: string, next_state?: string, players?: array<string>, stop_expression?: string}
...
type title_display_options = {fade_in_duration: int32, fade_out_duration: int32, stay_duration: int32, subtitle?: @unwrap[ | #Array(array<@unwrap[ | #RawMessage(raw_message) | #String(string) ]>) | #RawMessage(raw_message) | #String(string) ]}
...
module Entity = {
  type t = _Entity
  module Impl = ( T: { type t } ) => {
    @send @return(nullable) external addEffect: (T.t, @unwrap[ | #EffectType(_EffectType) | #String(string) ], int32, option<entity_effect_options>) => option<_Effect> = "addEffect"
...
module Dimension = {
  type t = _Dimension
  @send external createExplosion: (t, vector3, float, option<explosion_options>) => bool = "createExplosion"
  ...
  @send @return(nullable) external findClosestBiome: (t, vector3, @unwrap[ | #BiomeType(_BiomeType) | #String(string) ], option<biome_search_options>) => option<vector3> = "findClosestBiome"
...
module EntityProjectileComponent = {
  ...
  include EntityComponent.Impl({ type t = t })
  @module("@minecraft/server") @scope("EntityProjectileComponent") @val external componentId: string = "componentId"
  @send external shoot: (t, vector3, option<projectile_shoot_options>) => unit = "shoot"
  ...
  @set external setCritParticlesOnProjectileHurt: (t, bool) => unit = "critParticlesOnProjectileHurt"
...
module ItemEnchantableComponent = {
  ...
  include ItemComponent.Impl({ type t = t })
  @module("@minecraft/server") @scope("ItemEnchantableComponent") @val external componentId: string = "componentId"
  ...
  @send @return(nullable) external getEnchantment: (t, @unwrap[ | #EnchantmentType(_EnchantmentType) | #String(string) ]) => option<enchantment> = "getEnchantment"
  @send external getEnchantments: (t) => array<enchantment> = "getEnchantments"
  @send external hasEnchantment: (t, @unwrap[ | #EnchantmentType(_EnchantmentType) | #String(string) ]) => bool = "hasEnchantment"
...
module Scoreboard = {
  type t = _Scoreboard
  @send external addObjective: (t, string, option<string>) => _ScoreboardObjective = "addObjective"
...
module WeatherChangeBeforeEventSignal = {
  ...
  @send external subscribe: (t, (_WeatherChangeBeforeEvent) => unit) => (_WeatherChangeBeforeEvent) => unit = "subscribe"
...
module WorldAfterEvents = {
  ...
  @get external dataDrivenEntityTrigger: t => _DataDrivenEntityTriggerAfterEventSignal = "dataDrivenEntityTrigger"
